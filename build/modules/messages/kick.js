                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (initiator.playerData.permission < 50) {
                            return [2 /*return*/, socket.modules.messages.sendToPlayer(initiator, 'System', "You don't have the permission to kick a player.", 'error')];
                        }
                    ...
                    case 1:
                        ...
                        socket.modules.messages.sendToAll('System', "".concat(players[targetsName].playerData.username, " was kicked!"), 'error');
                        return [2 /*return*/, players[targetsName].disconnect()];
                }
            });
        });
    };
