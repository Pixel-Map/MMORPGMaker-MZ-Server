...
exports.initialize = function (mmoCore) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (initiator.isInParty === false) {
                    return [2 /*return*/, socket.modules.messages.sendToPlayer(initiator, 'System', 'You are not in a party.', 'error')];
                }
    ...
    // ---------------------------------------
    socket.serverEvent.on('player-left-party', function (payload) {
        socket.modules.messages.sendToParty(payload.partyName, 'System', "".concat(payload.player.playerData.username, " left the party!"), 'action');
    });
};
