                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (targetsName === initiator.playerData.username) {
                            return [2 /*return*/, socket.modules.messages.sendToPlayer(initiator, 'System', "You can't give money to yourself.", 'error')];
                        }
                        if (isNaN(args[2])) {
                            return [2 /*return*/, socket.modules.messages.sendToPlayer(initiator, 'System', 'Amount is not valid.', 'error')];
                        }
                    ...
                    case 1:
                        ...
                        database.savePlayer({
                            ...
                            socket.modules.messages.sendToPlayer(initiator, 'System', "You gave ".concat(args[2], " gold to ").concat(players[targetsName].playerData.username, "!"), 'action');
                        });
                        ...
                        database.savePlayer({
                            ...
                            socket.modules.messages.sendToPlayer(players[targetsName], 'System', "".concat(initiator.playerData.username, " gave you ").concat(args[2], " gold!"), 'action');
                        });
                        return [2 /*return*/];
                }
            });
