...
(function (d) {
  ...
  r(p.prototype, {
    ...
    initDataClasses: function (a) {
      ...
      h(a.dataClasses, function (a, d) {
        var h,
            a = j(a);
        f.push(a);
        if (!a.color) l.dataClassColor === "category" ? (h = c.options.colors, a.color = h[e++], e === h.length && (e = 0)) : a.color = b.tweenColors(i(l.minColor), i(l.maxColor), g < 2 ? 0.5 : d / (g - 1));
      });
    },
    ...
    setAxisSize: function () {
      var a = this.legendSymbol,
          ...
          f,
          e;
      if (a) this.left = c = a.attr("x"), this.top = f = a.attr("y"), this.width = e = a.attr("width"), this.height = a = a.attr("height"), this.right = b.chartWidth - c - e, this.bottom = b.chartHeight - f - a, this.len = this.horiz ? e : a, this.pos = this.horiz ? c : f;
    },
  ...
  w(x.prototype, "getAllItems", function (a) {
    ...
    c && (c.options.dataClasses ? b = b.concat(c.getDataClassLegendSymbols()) : b.push(c), h(c.series, function (a) {
    ...
    translate: function () {
      ...
      h(this.points, function (e) {
        var d = (a.colsize || 1) / 2,
            ...
            g = f(Math.round(c.translate(e.y + g, 0, 1, 0, 1)), -c.len, 2 * c.len);
