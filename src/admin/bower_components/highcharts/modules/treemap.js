  ...
  i.treemap = u(i.scatter, m({
    ...
    buildNode: function (a, b, c, d, e) {
      var h = this,
          ...
          A;
      k(d[a] || [], function (b) {
        A = h.buildNode(h.points[b].id, b, c + 1, d, a);
        g.push(A);
      });
      b = {
        id: a,
    ...
    setTreeValues: function (a) {
      ...
      h = j(g && g.options.value, d);
      if (g) g.value = h;
      t(a, {
        children: e,
        childrenTotal: d,
        ignore: !(j(g && g.visible, !0) && h > 0),
        isLeaf: a.visible && !d,
        levelDynamic: c.levelIsConstant ? a.level : a.level - b.nodeMap[b.rootNode].level,
        name: j(g && g.name, ""),
        sortIndex: j(g && g.sortIndex, -h),
        val: h
      });
      return a;
    },
    ...
    setPointValues: function () {
      ...
      k(this.points, function (c) {
        var d = c.node,
            ...
            h,
            g;
        e && d.visible ? (d = Math.round(a.translate(e.x, 0, 0, 0, 1)), h = Math.round(a.translate(e.x + e.width, 0, 0, 0, 1)), g = Math.round(b.translate(e.y, 0, 0, 0, 1)), e = Math.round(b.translate(e.y + e.height, 0, 0, 0, 1)), c.shapeType = "rect", c.shapeArgs = {
          x: Math.min(d, h),
          y: Math.min(g, e),
          width: Math.abs(h - d),
          height: Math.abs(e - g)
    ...
    setColorRecursive: function (a, b) {
      ...
      if (a) {
        ...
        b = j(d && d.options.color, e && e.color, b);
        if (d) d.color = b;
    ...
    algorithmCalcPoints: function (a, b, c, d) {
      var e,
          ...
          o = 0,
          p = c.elArr.length - 1;
      b ? (j = c.nW, s = c.nH) : i = c.elArr[c.elArr.length - 1];
      k(c.elArr, function (a) {
        if (b || o < p) c.direction === 0 ? (e = l.x, h = l.y, g = j, f = a / g) : (e = l.x, h = l.y, f = s, g = a / f), d.push({
          x: e,
          y: h,
          width: g,
          height: f
        }), c.direction === 0 ? l.y += f : l.x += g;
        o += 1;
      });
      c.reset();
      c.direction === 0 ? c.width -= j : c.height -= s;
    ...
    algorithmLowAspectRatio: function (a, b, c) {
      var d = [],
        ...
        parent: b
          ...
          f = 0,
          j = c.length - 1,
          i = new this.algorithmGroup(b.height, b.width, b.direction, g);
      k(c, function (c) {
        h = b.width * b.height * (c.val / b.val);
        i.addElement(h);
        i.lP.nR > i.lP.lR && e.algorithmCalcPoints(a, !1, i, d, g);
        f === j && e.algorithmCalcPoints(a, !0, i, d, g);
        f += 1;
      });
      return d;
    },
    algorithmFill: function (a, b, c) {
      ...
      k(c, function (c) {
        ...
        l = g;
        n = i;
        f === 0 ? (p = m, o = e / p, j -= o, g += o) : (o = j, p = e / o, m -= p, i += p);
        d.push({
          x: l,
          y: n,
          width: o,
    ...
    translate: function () {
      ...
      this.rootNode = j(this.options.rootId, "");
    ...
    drawDataLabels: function () {
      ...
      k(b, function (b) {
        ...
        if (b.shapeArgs) c.style.width = b.shapeArgs.width, b.dataLabel && b.dataLabel.css({
    ...
    pointAttribs: function (a, b) {
      var c = this.levelMap[a.node.levelDynamic] || {},
        ...
        "stroke-width": j(a.borderWidth, c.borderWidth, e.borderWidth, d.borderWidth),
    ...
    drawPoints: function () {
      ...
      k(b, function (c) {
        ...
        b = parseInt(b["stroke-width"], 10) % 2 / 2;
        c.shapeArgs.x -= b;
        c.shapeArgs.y -= b;
      });
