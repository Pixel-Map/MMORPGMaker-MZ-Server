(function (e) {
  ...
  function A(b, a, d) {
    var c;
    !a.rgba.length || !b.rgba.length ? b = a.input || "none" : (b = b.rgba, a = a.rgba, c = a[3] !== 1 || b[3] !== 1, b = (c ? "rgba(" : "rgb(") + Math.round(a[0] + (b[0] - a[0]) * (1 - d)) + "," + Math.round(a[1] + (b[1] - a[1]) * (1 - d)) + "," + Math.round(a[2] + (b[2] - a[2]) * (1 - d)) + (c ? "," + (a[3] + (b[3] - a[3]) * (1 - d)) : "") + ")");
    return b;
  }
  ...
  l.prototype.addSingleSeriesAsDrilldown = function (b, a) {
    ...
    (n = this.drilldownLevels[this.drilldownLevels.length - 1]) && n.levelNumber !== k && (n = void 0);
    if (!a.color) a.color = f;
    a._ddSeriesId = z++;
    h = y(b, d.points);
    ...
    f = f.lowerSeries = this.addSeries(a, !1);
  ...
  l.prototype.applyDrilldown = function () {
    var b = this.drilldownLevels,
        a;
    if (b && b.length > 0) a = b[b.length - 1].levelNumber, i(this.drilldownLevels, function (b) {
  ...
  l.prototype.showDrillUpButton = function () {
    ...
    this.drillUpButton ? this.drillUpButton.attr({
      text: a
    }).align() : (g = (c = d.theme) && c.states, this.drillUpButton = this.renderer.button(a, null, null, function () {
      b.drillUp();
  ...
  l.prototype.drillUp = function () {
    for (var b = this, a = b.drilldownLevels, d = a[a.length - 1].levelNumber, c = a.length, g = b.series, f, h, e, j, k = function (a) {
      ...
      if (j.type === e.type) j.drilldownLevel = h, j.options.animation = b.options.drilldown.animation, e.animateDrillupFrom && e.chart && e.animateDrillupFrom(h);
      j.options._levelNumber = d;
      e.remove(!1);
      if (j.xAxis) f = h.oldExtremes, j.xAxis.setExtremes(f.xMin, f.xMax, !1), j.yAxis.setExtremes(f.yMin, f.yMax, !1);
    }
  ...
  m.prototype.animateDrillupTo = function (b) {
    if (!b) {
      var a = this,
          d = a.drilldownLevel;
  ...
  m.prototype.animateDrilldown = function (b) {
    ...
    if (!b) i(d, function (b) {
      ...
      b.graphic && b.graphic.attr(c).animate(o(b.shapeArgs, {
        fill: b.color || a.color
      }), g);
      b.dataLabel && b.dataLabel.fadeIn(g);
    }), this.animate = null;
  };
  ...
  m.prototype.animateDrillupFrom = function (b) {
    ...
    i(this.points, function (c) {
      ...
      f && (delete c.graphic, a ? f.animate(o(b.shapeArgs, {
        fill: b.color
      }), e.merge(a, {
        complete: h
      })) : (f.attr(b.shapeArgs), h()));
    });
  };
  ...
  w && o(w.prototype, {
    ...
    animateDrilldown: function (b) {
      var a = this.chart.drilldownLevels[this.chart.drilldownLevels.length - 1],
          ...
          c = a.shapeArgs,
          g = c.start,
          f = (c.end - g) / this.points.length;
      if (!b) i(this.points, function (b, i) {
        b.graphic.attr(e.merge(c, {
          start: g + i * f,
          end: g + (i + 1) * f,
          fill: a.color
        }))[d ? "animate" : "attr"](o(b.shapeArgs, {
          fill: b.color
        }), d);
      }), this.animate = null;
    }
  ...
  e.Axis.prototype.drilldownCategory = function (b, a) {
    ...
    for (d in e) (c = e[d]) && c.series && c.series.visible && c.doDrilldown && c.doDrilldown(!0, b, a);
  ...
  e.Axis.prototype.getDDPoints = function (b, a) {
    ...
    d[b] || (d[b] = []);
    if (d[b].levelNumber !== a) d[b].length = 0;
    return d[b];
  };
  ...
  x.prototype.drillable = function () {
    var b = this.pos,
        a = this.label,
        d = this.axis,
        c = d.ddPoints && d.ddPoints[b];

    if (a && c && c.length) {
      if (!a.basicStyles) a.basicStyles = e.merge(a.styles);
      a.addClass("highcharts-drilldown-axis-label").css(d.chart.options.drilldown.activeAxisLabelStyle).on("click", function (a) {
  ...
  r(e.Point.prototype, "init", function (b, a, d, c) {
    var g = b.call(this, a, d, c),
        ...
        d = d && d.getDDPoints(c, a.options._levelNumber);
    if (g.drilldown && (e.addEvent(g, "click", function (b) {
      a.xAxis && a.chart.options.drilldown.allowPointDrilldown === !1 ? a.xAxis.drilldownCategory(c, b) : g.doDrilldown(void 0, void 0, b);
    }), d)) d.push(g), d.levelNumber = a.options._levelNumber;
    b && b.drillable();
    return g;
  });
  r(e.Series.prototype, "drawDataLabels", function (b) {
    ...
    i(a.points, function (b) {
      ...
      if (b.drilldown && b.dataLabel) {
        if (d.color === "contrast") e.color = c.getContrast(b.color || a.color);
        b.dataLabel.attr({
