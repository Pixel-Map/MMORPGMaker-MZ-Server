...
(function (M, ja) {
  ...
  function $(a, b, c) {
    var d, e;
    if (Ea(b)) t(c) ? a.setAttribute(b, c) : a && a.getAttribute && (e = a.getAttribute(b));else if (t(b) && ha(b)) for (d in b) a.setAttribute(d, b[d]);
    return e;
  }
  ...
  Ab.prototype = {
    ...
    initPath: function (a, b, c) {
      ...
      function f(a, b) {
        for (var c = (l - a.length) / k; c > 0 && c--;) m = a.slice().splice(a.length / r - k, k * r), m[0] = b[l - k - c * k], j && (m[k - 6] = m[k - 2], m[k - 5] = m[k - 1]), [].splice.apply(a, [a.length / r, 0].concat(m)), p && c--;
      }
  ...
  ya = function (a, b) {
    var c;
    if (b === "width") return Math.min(a.offsetWidth, a.scrollWidth) - ya(a, "padding-left") - ya(a, "padding-right");else if (b === "height") return Math.min(a.offsetHeight, a.scrollHeight) - ya(a, "padding-top") - ya(a, "padding-bottom");
  ...
  Qa = function (a) {
    for (var b = Ua.length; b--;) if (Ua[b].elem === a) Ua[b].stopped = !0;
  };
  ...
  K = function (a, b, c, d) {
    ...
    var f,
        g,
        c = c || {};
    if (C.createEvent && (a.dispatchEvent || a.fireEvent)) e = C.createEvent("Events"), e.initEvent(b, !0, !0), e.target = a, v(e, c), a.dispatchEvent ? a.dispatchEvent(e) : a.fireEvent(b, e);else if (e) {
      e = e[b] || [];
      f = e.length;
  ...
  xa.prototype = {
    ...
    brighten: function (a) {
      ...
      if (this.stops) o(this.stops, function (b) {
        b.brighten(a);
      });else if (z(a) && a !== 0) for (b = 0; b < 3; b++) c[b] += H(a * 255), c[b] < 0 && (c[b] = 0), c[b] > 255 && (c[b] = 255);
      return this;
    },
  ...
  ba.prototype = {
    ...
    colorGradient: function (a, b, c) {
      ...
      if (f) {
        ...
        f === "radialGradient" && n && !t(g.gradientUnits) && (h = g, g = D(g, d.getRadialAttr(n, h), {
          gradientUnits: "userSpaceOnUse"
        }));
        ...
        r = r.join(",");
        i[r] ? n = i[r].attr("id") : (g.id = n = "highcharts-" + Lb++, i[r] = j = d.createElement(f).attr(g).add(d.defs), j.radAttr = h, j.stops = [], o(k, function (a) {
          a[1].indexOf("rgba") === 0 ? (e = xa(a[1]), l = e.get("rgb"), m = e.get("a")) : (l = a[1], m = 1);
    ...
    css: function (a) {
      ...
      if (e) {
        ...
        if (La && !ma) O(this.element, a);else {
          b = function (a, b) {
    ...
    getBBox: function (a, b) {
      ...
      f = q(b, this.rotation);
      g = f * ta;
      e !== x && (p = ["", f || 0, i && i.fontSize, h.style.width].join(","), p = e === "" || cc.test(e) ? "num:" + e.toString().length + p : e + p);
      p && !a && (c = m[p]);
      ...
      if (!c) {
        if (h.namespaceURI === Ta || d.forExport) {
          try {
            ...
            }, Ya && k.textShadow ? (j = k.textShadow, k.textShadow = "") : l && l("none"), c = h.getBBox ? v({}, h.getBBox()) : {
              width: h.offsetWidth,
    ...
    zIndexSetter: function (a, b) {
      ...
      if (e) {
        ...
        for (i = 0; i < d.length && !h; i++) if (e = d[i], f = e.zIndex, e !== g && (H(f) > a || !t(a) && t(f))) c.insertBefore(g, e), h = !0;
  ...
  ba.prototype["stroke-widthSetter"] = ba.prototype.strokeSetter = function (a, b, c) {
    this[b] = a;
    if (this.stroke && this["stroke-width"]) this.strokeWidth = this["stroke-width"], ba.prototype.fillSetter.call(this, this.stroke, "stroke", c), c.setAttribute("stroke-width", this["stroke-width"]), this.hasStroke = !0;else if (b === "stroke-width" && a === 0 && this.hasStroke) c.removeAttribute("stroke"), this.hasStroke = !1;
  };
  ...
  za.prototype = {
    ...
    init: function (a, b, c, d, e, f) {
      ...
      this.setSize(b, c, !1);
      var h;
      if (Ya && a.getBoundingClientRect) this.subPixelFix = b = function () {
        O(a, {
          left: 0,
          top: 0
        });
      ...
      !f && !p && !r && !m && e.indexOf(" ") === -1 ? b.appendChild(C.createTextNode(w(e))) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, Z && Z.appendChild(b), e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g) : [e], e = Ha(e, function (a) {
        ...
        o(g, function (e) {
          if (e !== "" || g.length === 1) {
            ...
            i.test(e) && !d && ($(s, "onclick", 'location.href="' + e.match(i)[1] + '"'), O(s, {
              cursor: "pointer"
            }));
            e = w(e.replace(/<(.|\n)*?>/g, "") || " ");
            ...
            if (e !== " ") {
              ...
              if (m) {
                for (var p = e.replace(/([^\^])-/g, "$1- ").split(" "), Z = g.length > 1 || f || p.length > 1 && l.whiteSpace !== "nowrap", o, F, t = [], y = u(s), x = 1, A = a.rotation, v = e, B = v.length; (Z || r) && (p.length || t.length);) a.rotation = 0, o = a.getBBox(!0), F = o.width, !ma && c.forExport && (F = c.measureSpanWidth(s.firstChild.data, a.styles)), o = F > m, j === void 0 && (j = o), r && j ? (B /= 2, v === "" || !o && B < 0.5 ? p = [] : (v = e.substring(0, v.length + (o ? -1 : 1) * Ga(B)), p = [v + (m > 3 ? "\u2026" : "")], s.removeChild(s.firstChild))) : !o || p.length === 1 ? (p = t, t = [], p.length && (x++, s = C.createElementNS(Ta, "tspan"), $(s, {
                  dy: y,
                  x: k
                }), q && $(s, "style", q), b.appendChild(s)), F > m && (m = F)) : (s.removeChild(s.firstChild), t.unshift(p.pop())), p.length && s.appendChild(C.createTextNode(p.join(" ").replace(/- /g, "-")));
    ...
    symbol: function (a, b, c, d, e, f) {
      var g = this,
          ...
          k,
          l;
      if (i) h = this.path(i), v(h, {
        symbolName: a,
        x: b,
        y: c,
        width: d,
        height: e
      }), f && v(h, f);else if (j.test(a)) l = function (a, b) {
        a.element && (a.attr({
          width: b[0],
          height: b[1]
        }), a.alignByTranslate || a.translate(A((d - b[0]) / 2), A((e - b[1]) / 2)));
      }, k = a.match(j)[1], a = Yb[k] || f && f.width && f.height && [f.width, f.height], h = this.image(k).attr({
        x: b,
        y: c
        ...
        onload: function () {
          ...
          g.imgCount--;
          if (!g.imgCount && ca[g.chartIndex].onload) ca[g.chartIndex].onload();
        },
        src: k
      }), this.imgCount++);
      return h;
    ...
    fontMetrics: function (a, b) {
      ...
      !a && b && M.getComputedStyle && (b = b.element || b, a = (c = M.getComputedStyle(b, "")) && c.fontSize);
      ...
      if (this.added) {
        ...
        if (b.tagName === "SPAN") {
          ...
          if (m !== this.cTT) {
            ...
            if (b.offsetWidth > k && /[ \-]/.test(b.textContent || b.innerText)) O(b, {
              width: k + "px",
              display: "block",
              whiteSpace: l || "normal"
            });
  ...
  if (!ma && !ua) da = {
    ...
    getSpanCorrection: function (a, b, c, d, e) {
      ...
      e && e !== "left" && (this.xCorr -= a * c * (f < 0 ? -1 : 1), d && (this.yCorr -= h * c * (g < 0 ? -1 : 1)), O(this.element, {
        textAlign: e
      }));
    },
    pathToVML: function (a) {
      for (var b = a.length, c = []; b--;) if (z(a[b])) c[b] = A(a[b] * 10) - 5;else if (a[b] === "Z") c[b] = "x";else if (c[b] = a[b], a.isArc && (a[b] === "wa" || a[b] === "at")) c[b + 5] === c[b + 7] && (c[b + 7] += a[b + 7] > a[b + 5] ? 1 : -1), c[b + 6] === c[b + 8] && (c[b + 8] += a[b + 8] > a[b + 6] ? 1 : -1);
    ...
    clip: function (a) {
      var b = this,
          c;
      a ? (c = a.members, Ba(c, b), c.push(b), b.destroyClip = function () {
        Ba(c, b);
    ...
    color: function (a, b, c, d) {
      ...
      if (i) {
        ...
        w[0] < 1 && a.push([1, w[1]]);
        o(a, function (a, b) {
          g.test(a[1]) ? (f = xa(a[1]), k = f.get("rgb"), l = f.get("a")) : (k = a[1], l = 1);
          F.push(a[0] * 100 + "% " + k);
          b ? (r = l, s = k) : (p = l, q = k);
        });
        if (c === "fill") {
  ...
  var Zb;
  if (ua) B.CanVGRenderer = da = function () {
  ...
  eb.prototype = {
    addLabel: function () {
      ...
      t(d) ? d && d.attr({
        text: b
      }) : (this.labelLength = (this.label = d = t(b) && g.enabled ? c.renderer.text(b, 0, 0, g.useHTML).css(D(g.style)).add(a.labelGroup) : null) && d.getBBox().width, this.rotation = 0);
    },
    ...
    handleOverflow: function (a) {
      var b = this.axis,
        ...
        right: 1
          ...
          n,
          p = {};
      if (h) h < 0 && c - i * j < f ? n = A(c / fa(h * ta) - f) : h > 0 && c + i * j > e && (n = A((d - c) / fa(h * ta)));else if (d = c + (1 - i) * j, c - i * j < f ? l = a.x + l * (1 - i) - f : d > e && (l = e - a.x + l * i, m = -1), l = E(k, l), l < k && b.labelAlign === "center" && (a.x += m * (k - l - i * (k - E(j, l)))), j > l || b.autoRotation && g.styles.width) n = l;
    ...
    render: function (a, b, c) {
      ...
      if (m) d.opposite && (m[0] = -m[0]), h = this.getMarkPath(ka, L, m[0], m[1] * t, g, f), o ? o.animate({
        d: h,
        opacity: c
  ...
  B.PlotLineOrBand.prototype = {
    render: function () {
      ...
      } else if (n && n.length && (a.svgElem = m = w.path(n).attr(u).add(), o)) for (p in d = function (b) {
        m.on(b, function (c) {
          o[b].apply(a, [c]);
        });
      }, o) d(p);
  ...
  J.prototype = {
    ...
    defaultLabelFormatter: function () {
      ...
      if (h) g = Ma(h, this);else if (c) g = b;else if (d) g = pa(d, b);else if (f && a >= 1E3) for (; f-- && g === x;) c = Math.pow(1E3, f + 1), a >= c && b * 10 % c === 0 && e[f] !== null && b !== 0 && (g = B.numberFormat(b / c, -1) + e[f]);
    ...
    adjustForMinRange: function () {
      var a = this.options,
          ...
          j,
          k;
      if (this.isXAxis && this.minRange === x && !this.isLog) t(a.min) || t(a.max) ? this.minRange = null : (o(this.series, function (a) {
        i = a.xData;
    ...
    setAxisTranslation: function (a) {
      var b = this,
          ...
          j = b.transA,
          k = b.isXAxis;
      if (k || i || d) if (h ? (f = h.minPointOffset, g = h.pointRangePadding) : (e = b.getClosest(), o(b.series, function (a) {
        var c = i ? 1 : k ? q(a.options.pointRange, e, 0) : b.axisPointRange || 0,
            a = a.options.pointPlacement;
        d = y(d, c);
        b.single || (f = y(f, Ea(a) ? 0 : c / 2), g = y(g, a === "on" ? 0 : c));
    ...
    setTickInterval: function (a) {
      ...
      u = q(b.userMin, d.min);
      w = q(b.userMax, d.max);
      i ? (b.linkedParent = c[b.coll][d.linkedTo], c = b.linkedParent.getExtremes(), b.min = q(c.min, c.dataMin), b.max = q(c.max, c.dataMax), d.type !== b.linkedParent.options.type && ja(11, 1)) : (!r && t(p) && (b.dataMin >= p ? (s = p, k = 0) : b.dataMax <= p && (Z = p, j = 0)), b.min = q(u, s, b.dataMin), b.max = q(w, Z, b.dataMax));
      ...
      if (z(d.ceiling)) b.max = E(b.max, d.ceiling);
      if (r && t(b.dataMin)) if (p = p || 0, !t(u) && b.min < p && b.dataMin >= p) b.min = p;else if (!t(w) && b.max > p && b.dataMax <= p) b.max = p;
    ...
    unsquish: function () {
      ...
      b ? (k = !a.staggerLines && !a.step && (t(g) ? [g] : e < q(a.autoRotationLimit, 80) && a.autoRotation)) && o(k, function (a) {
        var b;
        if (a === g || a && a >= -90 && a <= 90) i = l(T(h.h / na(ta * a))), b = i + T(a / 360), b < j && (j = b, f = a, d = i);
      }) : a.step || (d = l(h.h));
      this.autoRotation = k;
    ...
    renderUnsquish: function () {
      ...
      if (this.autoRotation) o(c, function (a) {
        ...
        for (n = c.length; !f && n--;) if (p = c[n], h = d[p].label) if (h.styles.textOverflow === "ellipsis" ? h.css({
          textOverflow: "clip"
    ...
    getOffset: function () {
      ...
      } else for (F in f) f[F].destroy(), delete f[F];

      if (p && p.text && p.enabled !== !1) {
        if (!a.axisTitle) (F = p.textAlign) || (F = (g ? {
          low: "left",
          middle: "center",
          high: "right"
        } : {
    ...
    render: function () {
      ...
      if (a.hasData() || g) {
        ...
        }), p && (a.min === 0 || a.single))) j[-1] || (j[-1] = new eb(a, -1, null, !0)), j[-1].render(-1);
        n && o(h, function (c, d) {
          L = h[d + 1] !== x ? h[d + 1] + p : a.max - p;
          if (d % 2 === 0 && c < a.max && L <= a.max + (b.polar ? -p : p)) l[c] || (l[c] = new B.PlotLineOrBand(a)), F = c + p, l[c].options = {
            from: e ? f(F) : F,
            to: e ? f(L) : L,
            color: n
      ...
      if (i && u) i[i.isNew ? "attr" : "animate"](a.getTitlePosition()), i.isNew = !1;
    ...
    drawCrosshair: function (a, b) {
      ...
      if (!this.crosshair || (t(b) || !q(d.snap, !0)) === !1) this.hideCrosshair();else if (q(d.snap, !0) ? t(b) && (c = this.isXAxis ? b.plotX : this.len - b.plotY) : c = this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos, c = this.isRadial ? this.getPlotLinePath(this.isXAxis ? b.x : q(b.stackY, b.y)) || null : this.getPlotLinePath(null, null, null, null, c) || null, c === null) this.hideCrosshair();else {
  ...
  J.prototype.getTimeTicks = function (a, b, c, d) {
    ...
    if (t(b)) {
      ...
      if (j >= N.minute) i[Tb](j >= N.hour ? 0 : k * Y(i[Eb]() / k));
      ...
      for (var d = i.getTime(), l = i[jb](), m = i[db](), n = !g || !!hb, p = (N.day + (g ? gb(i) : i.getTimezoneOffset() * 6E4)) % N.day; d < c;) e.push(d), j === N.year ? d = rb(h + b * k, 0) : j === N.month ? d = rb(h, l + b * k) : n && (j === N.day || j === N.week) ? d = rb(h, l, m + b * k * (j === N.day ? 1 : 7)) : d += j * k, b++;
  ...
  J.prototype.normalizeTimeTickInterval = function (a, b) {
    ...
    for (g = 0; g < c.length; g++) if (d = c[g], e = N[d[0]], f = d[1], c[g + 1] && a <= (e * f[f.length - 1] + N[c[g + 1][0]]) / 2) break;
  ...
  J.prototype.getLogTickPositions = function (a, b, c, d) {
    ...
    if (a >= 0.5) a = A(a), i = this.getLinearTickPositions(a, b, c);else if (a >= 0.08) for (var f = Y(b), j, k, l, m, n, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !n; f++) {
      k = e.length;

      for (j = 0; j < k && !n; j++) l = h(g(f) * e[j]), l > b && (!d || m <= c) && m !== x && i.push(m), m > c && (n = !0), m = l;
  ...
  Nb.prototype = {
    ...
    getPosition: function (a, b, c) {
      var d = this.chart,
        ...
        var j = c < d - e,
            ...
            l = d - e - c;
        d += e;
        if (k && m) f[a] = d;else if (!k && j) f[a] = l;else if (j) f[a] = E(i - c, l - g < 0 ? l : l - g);else if (m) f[a] = y(h, d + g + c > b ? d : d + g);else return !1;
      },
          m = function (a, b, c, d) {
        var g;
    ...
    refresh: function (a, b) {
      ...
      j === !1 ? this.hide() : (this.isHidden && (Qa(d), d.attr("opacity", 1).show()), d.attr({
        text: j
  ...
  ab.prototype = {
    init: function (a, b) {
      ...
      this.pinchDown = [];
      this.lastValidTouch = {};
      if (B.Tooltip && b.tooltip.enabled) a.tooltip = new Nb(a, b.tooltip), this.followTouchMove = q(b.tooltip.followTouchMove, !0);
      this.setDOMEvents();
    },
    ...
    onContainerClick: function (a) {
      ...
      b.cancelClick || (c && this.inClass(a.target, "highcharts-tracker") ? (K(c.series, "click", v(a, {
        point: c
      })), b.hoverPoint && c.firePointEvent("click", a)) : (v(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY - e) && K(b, "click", a)));
    },
  ...
  if (M.PointerEvent || M.MSPointerEvent) {
    var Ia = {},
      ...
      for (a in Ia) Ia.hasOwnProperty(a) && b.push({
        pageX: Ia[a].pageX,
        pageY: Ia[a].pageY,
        target: Ia[a].target
      });
      ...
      return b;
        ...
        Pb = function (a, b, c, d) {
      if ((a.pointerType === "touch" || a.pointerType === a.MSPOINTER_TYPE_TOUCH) && ca[ra]) d(a), d = ca[ra].pointer, d[b]({
        type: c,
  ...
  xb.prototype = {
    init: function (a, b) {
      var c = this,
          ...
          e = b.itemMarginTop || 0;
      this.options = b;
      if (b.enabled) c.itemStyle = d, c.itemHiddenStyle = D(d, b.itemHiddenStyle), c.itemMarginTop = e, c.padding = d = q(b.padding, 8), c.initialItemX = d, c.initialItemY = d - 5, c.maxItemWidth = 0, c.chart = a, c.itemHeight = 0, c.symbolWidth = q(b.symbolWidth, 16), c.pages = [], c.render(), G(c.chart, "endResize", function () {
    ...
    handleOverflow: function (a) {
      ...
      if (a > f && j.enabled !== !1) {
        ...
        if (!i) i = b.clipRect = d.clipRect(0, p, 9999, 0), b.contentGroup.clip(i);
        Z(h);
        ...
        b.scroll(0);
        a = f;
      } else if (m) Z(c.chartHeight), m.hide(), this.scrollGroup.attr({
        translateY: 1
      }), this.clipHeight = 0;
    ...
    scroll: function (a, b) {
      var c = this.pages,
          ...
          j = this.padding;
      e > d && (e = d);
      if (e > 0) b !== x && cb(b, this.chart), this.nav.attr({
        translateX: j,
  ...
  Da.prototype = {
    ...
    layOutTitles: function (a) {
      ...
      }, e), !1, h), !e.floating && !e.verticalAlign && (b = Ga(b + d.getBBox().height)));
    ...
    cloneRenderTo: function (a) {
      var b = this.renderToClone,
          c = this.container;
      a ? b && (this.renderTo.appendChild(c), Wa(b), delete this.renderToClone) : (c && c.parentNode === this.renderTo && this.renderTo.removeChild(c), this.renderToClone = b = this.renderTo.cloneNode(0), O(b, {
        position: "absolute",
        top: "-9999px",
        display: "block"
    ...
    drawChartBox: function () {
      ...
      if (k) f ? f.animate(o) : this.plotBackground = b.rect(p, r, s, q, 0).attr({
        fill: k
    ...
    linkSeries: function () {
      ...
      o(b, function (b) {
        ...
        if (Ea(d) && (d = d === ":previous" ? a.series[b.index - 1] : a.get(d))) d.linkedSeries.push(b), b.linkedParent = d, b.visible = q(b.options.visible, d.options.visible, b.visible);
      });
    },
  ...
  Ja.prototype = {
    ...
    optionsToObject: function (a) {
      var b = {},
          ...
          g = 0,
          h = 0;
      if (z(a) || a === null) b[e[0]] = a;else if (Ra(a)) {
        if (!d && a.length > f) {
          c = typeof a[0];
  ...
  P.prototype = {
    ...
    autoIncrement: function (a) {
      ...
      var b = this.options,
          ...
          e = this.xAxis,
          f,
          c = q(c, b.pointStart, 0);
      this.pointInterval = b = q(this.pointInterval, b.pointInterval, 1);
      if (e && e.categories && a.name) if (this.requireSorting = !1, g = (f = Ra(e.categories)) ? e.categories : e.names, e = g, a = qa(a.name, e), a === -1) {
        if (!f) c = e.length;
      } else c = a;
      ...
      if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData && e.visible) o(a, function (a, b) {
        ...
        if (m && h > m) {
          ...
          if (z(k)) {
            ...
            if (r) for (c = 0; c < h; c++) k = a[c], n[c] = k[0], p[c] = k.slice(1, r + 1);else for (c = 0; c < h; c++) k = a[c], n[c] = k[0], p[c] = k[1];
          } else ja(12);
        } else for (c = 0; c < h; c++) a[c] !== x && (k = {
          series: e
    ...
    getExtremes: function (a) {
      ...
      for (l = 0; l < d; l++) if (j = c[l], k = a[l], i = k !== null && k !== x && (!b.isLog || k.length || k > 0), j = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (c[l + 1] || j) >= g && (c[l - 1] || j) <= h, i && j) if (i = k.length) for (; i--;) k[i] !== null && (e[f++] = k[i]);else e[f++] = k;
    ...
    translate: function () {
      ...
      for (var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis, f = this.points, g = f.length, h = !!this.modifyValue, i = a.pointPlacement, j = i === "between" || z(i), k = a.threshold, l = a.startFromThreshold ? k : 0, m, n, p, r, s = Number.MAX_VALUE, a = 0; a < g; a++) {
        ...
        if (b && this.visible && !o.isNull && F && F[u]) r = this.getStackIndicator(r, u, this.index), L = F[u], w = L.points[r.key], n = w[0], w = w[1], n === l && r.key === F[u].base && (n = q(k, e.min)), e.isLog && n <= 0 && (n = null), o.total = o.stackTotal = L.total, o.percentage = L.total && o.y / L.total * 100, o.stackY = w, L.setOffset(this.pointXOffset || 0, this.barW || 0);
    ...
    drawPoints: function () {
      ...
      if (l.enabled !== !1 || this._hasPointMarkers) for (f = b.length; f--;) if (g = b[f], d = Y(g.plotX), e = g.plotY, k = g.graphic, n = g.marker || {}, p = !!g.marker, a = o && n.enabled === x || n.enabled, r = g.isInside, a && z(e) && g.y !== null) {
        if (a = g.pointAttr[g.selected ? "select" : ""] || m, h = a.r, i = q(n.symbol, this.symbol), j = i.indexOf("url") === 0, k) k[r ? "show" : "hide"](!0).attr(a).animate(v({
          x: d - h,
          y: e - h
        }, k.symbolName ? {
          width: 2 * h,
    ...
    getAttribs: function () {
      ...
      var s = a.zones,
          ...
          u,
          w;
      b.marker ? (e.radius = +e.radius || +c.radius + +e.radiusPlus, e.lineWidth = e.lineWidth || c.lineWidth + e.lineWidthPlus) : (e.color = e.color || xa(e.color || g).brighten(e.brightness).get(), e.negativeColor = e.negativeColor || xa(e.negativeColor || h).brighten(e.brightness).get());
      ...
      if (!k || g < k || f) for (; g--;) {
        ...
        if (k.options) for (w in n) t(c[n[w]]) && (f = !0);
    ...
    getGraphPath: function (a, b, c) {
      ...
      o(a, function (g, l) {
        ...
        g.isNull && !t(b) && l > 0 ? j = !e.connectNulls : g.isNull && !b ? j = !0 : (l === 0 || j ? p = [W, g.plotX, g.plotY] : d.getPointSpline ? p = d.getPointSpline(a, g, l) : f ? (p = f === 1 ? [R, p.plotX, n] : f === 2 ? [R, (p.plotX + m) / 2, p.plotY, R, (p.plotX + m) / 2, n] : [R, m, p.plotY], p.push(R, m, n)) : p = [R, m, n], i.push(g.x), f && i.push(g.x), h.push.apply(h, p), j = !1);
      });
      h.xMap = i;
  ...
  P.prototype.setStackedPoints = function () {
    if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
      ...
      for (u = 0; u < d; u++) {
        ...
        e === "percent" ? (r = r ? i : j, k && m[r] && m[r][w] ? (r = m[r][w], s.total = r.total = y(r.total, s.total) + T(F) || 0) : s.total = V(s.total + (T(F) || 0))) : s.total = V(s.total + (F || 0));
        s.cum = q(s.cum, g) + (F || 0);
  ...
  P.prototype.setPercentStacks = function () {
    ...
    o([b, "-" + b], function (b) {
      ...
      for (var g = d.length, h, i; g--;) if (h = d[g], e = a.getStackIndicator(e, h, a.index), f = (i = c[b] && c[b][h]) && i.points[e.key], h = f) i = i.total ? 100 / i.total : 0, h[0] = V(h[0] * i), h[1] = V(h[1] * i), a.stackedYData[g] = h[1];
    });
  };
  ...
  v(Da.prototype, {
    ...
    showLoading: function (a) {
      ...
      if (!d) b.loadingDiv = d = ia(Xa, {
        className: "highcharts-loading"
      }, v(e.style, {
        zIndex: 10,
        display: "none"
      }), b.container), b.loadingSpan = ia("span", null, e.labelStyle, d), G(b, "redraw", f);
      b.loadingSpan.innerHTML = a || c.lang.loading;
      if (!b.loadingShown) O(d, {
        opacity: 0,
        display: ""
      }), fb(d, {
    ...
    drawGraph: function () {
      ...
      o(d, function (d) {
        ...
        g ? (g.endX = b.xMap, g.animate({
          ...
          fill: d[2] || d[1],
          zIndex: 0
        }, d[2] || (g["fill-opacity"] = q(c.fillOpacity, 0.75)), g = a[f] = a.chart.renderer.path(b).attr(g).add(a.group), g.isArea = !0);
        g.startX = b.xMap;
  ...
  Ka = oa(P, {
    ...
    translate: function () {
      ...
      o(a.points, function (c) {
        var d = E(q(c.yBottom, f), 9E4),
            ...
            t,
            u = y(h, d) - o;
        T(u) < g && g && (u = g, t = !e.reversed && !c.negative || e.reversed && c.negative, o = T(o - f) > g ? d - g : f - (t ? g : 0));
        c.barX = p;
        c.pointWidth = i;
    ...
    drawPoints: function () {
      ...
      o(a.points, function (h) {
        var i = h.graphic,
            j;
        if (z(h.plotY) && h.y !== null) f = h.shapeArgs, j = t(a.borderWidth) ? {
          "stroke-width": a.borderWidth
        } : {}, g = h.pointAttr[h.selected ? "select" : ""] || a.pointAttr[""], i ? (Qa(i), i.attr(j).attr(g)[b.pointCount < e ? "animate" : "attr"](D(f))) : h.graphic = d[h.shapeType](f).attr(j).attr(g).add(h.group || a.group).shadow(c.shadow, null, c.stacking && !c.borderRadius);else if (i) h.graphic = i.destroy();
      });
    },
    animate: function (a) {
      var b = this,
          ...
          e = this.chart.inverted,
          f = {};
      if (ma) a ? (f.scaleY = 0.001, a = E(c.pos + c.len, y(c.pos, c.toPixels(d.threshold))), e ? f.translateX = a - c.len : f.translateY = a, b.group.attr(f)) : (f[e ? "translateX" : "translateY"] = c.pos, b.group.animate(f, v(ib(b.options.animation), {
        step: function (a, c) {
          b.group.attr({
    ...
    if (d.enabled || a._hasPointLabels) a.dlProcessOptions && a.dlProcessOptions(d), j = a.plotGroup("dataLabelsGroup", "data-labels", k && !h ? "hidden" : "visible", d.zIndex || 6), k && (j.attr({
      ...
      if (k && !h) e.dataLabel = k.destroy();else if (h) {
        ...
        if (k) {
          ...
          if (w.color === "contrast") F.color = d.inside || d.distance < 0 || b.stacking ? l.getContrast(e.color || a.color) : "#000000";
          if (c) F.cursor = c;
  ...
  if (I.pie) I.pie.prototype.drawDataLabels = function () {
    ...
    if (a.visible && (e.enabled || a._hasPointLabels)) {
        ...
        if (K) {
          ...
          if (m > 0) {
            ...
            if (K > u) {
              ...
              for (z = K; z--;) H[z].rank >= u && H.splice(z, 1);
            ...
            for (z = 0; z < K; z++) {
              ...
              if (I < z && J[z] !== null) I = z;else for (u < K - z + I && J[z] !== null && (I = u - K + z); J[I] === null;) I++;
              M.push({
                i: I,
                y: J[I]
              });
      ...
      if (Fa(C) === 0 || this.verifyDataLabelOverflow(C)) this.placeDataLabels(), s && g && o(this.points, function (b) {
        j = b.connector;
        w = b.labelPos;
        if ((t = b.dataLabel) && t._pos && b.visible) B = t._attr.visibility, x = t.connX, v = t.connY, k = l ? [W, x + (w[6] === "left" ? 5 : -5), v, "C", x, v, 2 * w[2] - w[4], 2 * w[3] - w[5], w[2], w[3], R, w[4], w[5]] : [W, x + (w[6] === "left" ? 5 : -5), v, R, w[2], w[3], R, w[4], w[5]], j ? (j.animate({
          d: k
  ...
  var ob = B.TrackerMixin = {
    ...
    drawTrackerGraph: function () {
      ...
      if (e && !c) for (k = e + 1; k--;) d[k] === W && d.splice(k + 1, 0, d[k + 1] - i, d[k + 2], R), (k && d[k] === W || k === e) && d.splice(k, 0, R, d[k - 2] + i, d[k - 1]);
      j ? j.attr({
        d: d
    ...
    pan: function (a, b) {
      ...
      o(b === "xy" ? [1, 0] : [1], function (b) {
        var b = c[b ? "xAxis" : "yAxis"][0],
            ...
            i = i > h;
        if (b.series.length && (i || l > E(k.dataMin, k.min)) && (!i || j < y(k.dataMax, k.max))) b.setExtremes(l, j, !1, !1, {
          trigger: "pan"
        }), e = !0;
        c[d] = h;
      });
  ...
  v(Ja.prototype, {
    ...
    setState: function (a, b) {
      ...
      if (!(a === this.state && !b || this.selected && a !== "select" || f[a] && f[a].enabled === !1 || a && (j || h && i.enabled === !1) || a && l.states && l.states[a] && l.states[a].enabled === !1)) {
        if (this.graphic) g = g && this.graphic.symbolName && p.r, this.graphic.attr(D(p, g ? {
          x: c - g,
          y: d - g,
          width: 2 * g,
          height: 2 * g
    ...
    lin2val: function (a, b) {
      ...
      if (c) {
        var d = this.ordinalSlope,
            ...
            g,
            h;
        if (b) a < 0 ? a = c[0] : a > f ? a = c[f] : (f = Y(a), h = a - f);else for (; f--;) if (g = d * f + e, a >= g) {
          d = d * (f + 1) + e;
          h = (a - g) / (d - g);
          break;
        }
    ...
    if (c.options.ordinal && c.series.length) {
      ...
      if (m.ordinalPositions) {
        if (T(f) > 1) k && o(k, function (a) {
          a.setState();
        }), f < 0 ? (k = m, p = c.ordinalPositions ? c : m) : (k = c.ordinalPositions ? c : m, p = m), m = p.ordinalPositions, h > m[m.length - 1] && m.push(h), this.fixedRange = j - i, f = c.toFixedRange(null, null, l.apply(k, [n.apply(k, [i, !0]) + f, !0]), l.apply(p, [n.apply(p, [j, !0]) + f, !0])), f.min >= E(g.dataMin, i) && f.max <= y(h, j) && c.setExtremes(f.min, f.max, !0, !1, {
          trigger: "pan"
        }), this.mouseDownX = d, O(this.container, {
          cursor: "move"
        });
      } else e = !0;
    } else e = !0;
  ...
  P.prototype.gappedPath = function () {
    var a = this.options.gapSize,
        b = this.points.slice(),
        c = b.length - 1;
    if (a && c > 0) for (; c--;) b[c + 1].x - b[c].x > this.closestPointRange * a && b.splice(c + 1, 0, {
      isNull: !0
    });
  ...
  la.groupData = function (a, b, c, d) {
    ...
    for (; q <= j; q++) {
      for (; c[t + 1] !== void 0 && a[q] >= c[t + 1] || q === j;) if (k = c[t], l = d.apply(0, n), l !== x && (g.push(k), h.push(l), i.push({
        start: u,
        length: n[0].length
      })), u = q, n[0] = [], n[1] = [], n[2] = [], n[3] = [], t += 1, q === j) break;
      ...
      if (p) {
        ...
        for (l = 0; l < o; l++) if (w = k[p[l]], z(w)) n[l].push(w);else if (w === null) n[l].hasNulls = !0;
  ...
  S(Nb.prototype, "tooltipFooterHeaderFormatter", function (a, b, c) {
    var d = b.series,
        ...
        h,
        i = d.xAxis;
    return i && i.options.type === "datetime" && f && z(b.key) ? (a = d.currentDataGrouping, f = f.dateTimeLabelFormats, a ? (i = f[a.unitName], a.count === 1 ? g = i[0] : (g = i[1], h = i[2])) : !g && f && (g = this.getXDateFormat(b, e, i)), g = pa(g, b.key), h && (g += pa(h, b.key + a.totalRange - 1)), Ma(e[(c ? "footer" : "header") + "Format"], {
      point: v(b.point, {
        key: g
      }),
      series: d
  ...
  J.prototype.setDataGrouping = function (a, b) {
    ...
    if (this instanceof J) for (c = this.series.length; c--;) this.series[c].update({
      dataGrouping: a
  ...
  ga = oa(I.column, {
    ...
    drawPoints: function () {
      ...
      o(a.points, function (k) {
        if (k.plotY !== x) i = k.graphic, c = k.pointAttr[k.selected ? "selected" : ""] || a.pointAttr[""], f = c["stroke-width"] % 2 / 2, j = A(k.plotX) - f, g = A(k.shapeArgs.width / 2), h = ["M", j, A(k.yBottom), "L", j, A(k.plotY)], k.open !== null && (d = A(k.plotOpen) + f, h.push("M", j, d, "L", j - g, d)), k.close !== null && (e = A(k.plotClose) + f, h.push("M", j, e, "L", j + g, e)), i ? i.attr(c).animate({
          d: h
  ...
  I.flags = oa(I.column, {
    ...
    translate: function () {
      ...
      if (e && e.visible && i) {
        ...
        for (a = "plot" + a[0].toUpperCase() + a.substr(1); i-- && c[d];) if (e = c[d], l = h[i], l.x <= e.x && l[a] !== void 0) {
          if (e.x <= m) e.plotY = l[a], l.x < e.x && !g && (n = h[i + 1]) && n[a] !== x && (e.plotY += (e.x - l.x) / (n.x - l.x) * (n[a] - l[a]));
          d--;
          i++;
          if (d < 0) break;
        }
    ...
    drawPoints: function () {
      ...
      for (k = c.length; k--;) if (l = c[k], a = l.plotX > this.xAxis.len, f = l.plotX, f > 0 && (f -= q(l.lineWidth, h.lineWidth) % 2), m = l.stackIndex, j = l.options.shape || h.shape, g = l.plotY, g !== x && (g = l.plotY + i - (m !== x && m * h.stackDistance)), n = m ? x : l.plotX, p = m ? x : l.plotY, m = l.graphic, g !== x && f >= 0 && !a) a = l.pointAttr[l.selected ? "select" : ""] || b, s = q(l.options.title, h.title, "A"), m ? m.attr({
        text: s
      }).attr({
        x: f,
        y: g,
  ...
  tb.prototype = {
    ...
    position: function (a, b, c, d) {
      ...
      this.yOffset = g;
      f ? (this.width = this.yOffset = c = g = this.size, this.xOffset = b = 0, this.barWidth = d - c * 2, this.x = a += this.options.margin) : (this.height = this.xOffset = d = b = this.size, this.barWidth = c - d * 2, this.y += this.options.margin);
      this.group[h]({
        translateX: a,
        translateY: this.y
      });
    ...
    swapXY: function (a, b) {
      var c,
          d = a.length,
          e;
      if (b) for (c = 0; c < d; c += 3) e = a[c + 1], a[c + 1] = a[c + 2], a[c + 2] = e;
      return a;
    },
    setRange: function (a, b) {
      ...
      if (t(this.barWidth)) e = this.barWidth * Math.max(a, 0), f = this.barWidth * Math.min(b, 1), f = Math.max(V(f - e), c.minWidth), e = Math.floor(e + this.xOffset + this.yOffset), g = f / 2 - 0.5, this.from = a, this.to = b, d ? (this.scrollbarGroup[h]({
        translateY: e
      }), this.scrollbar[h]({
        height: f
        ...
        translateX: g
      }), this.scrollbarLeft = e, this.scrollbarTop = 0), f <= 12 ? this.scrollbarRifles.hide() : this.scrollbarRifles.show(!0), c.showFull === !1 && (a <= 0 && b >= 1 ? this.group.hide() : this.group.show()), this.rendered = !0;
    },
    initEvents: function () {
      var a = this;
      ...
      a.mouseMoveHandler = function (b) {
        var c = a.chart.pointer.normalize(b),
            ...
            e = a.initPositions;
        if (a.grabbedCenter && (!b.touches || b.touches[0][d] !== 0)) c = {
          chartX: (c.chartX - a.x - a.xOffset) / a.barWidth,
          chartY: (c.chartY - a.y - a.yOffset) / a.barWidth
        }[d], d = a[d], d = c - d, a.hasDragged = !0, a.updatePosition(e[0] + d, e[1] + d), a.hasDragged && K(a, "changed", {
          from: a.from,
          to: a.to,
          trigger: "scrollbar",
          DOMType: b.type,
  ...
  Jb.prototype = {
    ...
    render: function (a, b, c, d) {
      ...
      if (z(a) && z(b) && (!this.hasDragged || t(c))) {
        ...
        if (!(k.translate(d, !0) - k.translate(c, !0) < e.xAxis[0].minRange)) {
          ...
          b = A(this.zoomedMax);
          a = A(this.zoomedMin);
          if (!w && p) this.navigatorGroup = k = f.g("navigator").attr({
            zIndex: 3
          }).add(), this.leftShade = f.rect().attr({
            fill: l.maskFill
          }).add(k), l.maskInside ? this.leftShade.css({
            cursor: "ew-resize"
          ...
          if (this.scrollbar) this.scrollbar.hasDragged = this.hasDragged, this.scrollbar.position(this.scrollerLeft, this.top + (p ? this.height : -this.scrollbarHeight), this.scrollerWidth, this.scrollbarHeight), this.scrollbar.setRange(a / h, b / h);
          this.rendered = !0;
        }
      }
    },
    ...
    init: function () {
      ...
      a.mouseDownHandler = function (d) {
        var d = b.pointer.normalize(d),
            ...
            y,
            z = lb ? 10 : 7;
        if (x > h && x < h + g) if (aa.abs(v - e - l) < z) a.grabbedLeft = !0, a.otherHandlePos = f, a.fixedExtreme = d.max, b.fixedRange = null;else if (aa.abs(v - f - l) < z) a.grabbedRight = !0, a.otherHandlePos = e, a.fixedExtreme = d.min, b.fixedRange = null;else if (v > l + e - q && v < l + f + q) a.grabbedCenter = v, a.fixedWidth = t, i = v - e;else if (v > j && v < j + k) {
          f = v - l - t / 2;
          if (f < 0) f = 0;else if (f + t >= o) f = o - t, y = a.getUnionExtremes().dataMax;
          if (f !== e) a.fixedWidth = t, e = c.toFixedRange(f, f + t, null, y), d.setExtremes(e.min, e.max, !0, null, {
            trigger: "navigator"
          });
        }
      };
      ...
      a.mouseMoveHandler = function (c) {
        ...
        if (!c.touches || c.touches[0].pageX !== 0) {
          ...
          if (a.grabbedLeft) a.hasDragged = !0, a.render(0, 0, k - e, a.otherHandlePos);else if (a.grabbedRight) a.hasDragged = !0, a.render(0, 0, a.otherHandlePos, k - e);else if (a.grabbedCenter) a.hasDragged = !0, k < i ? k = i : k > f + i - j && (k = f + i - j), a.render(0, 0, k - i, k - i + j);
          if (a.hasDragged && a.scrollbar && a.scrollbar.options.liveRedraw) c.DOMType = c.type, setTimeout(function () {
            a.mouseUpHandler(c);
          }, 0);
        }
      };
      ...
      if (b.options.scrollbar.enabled) a.scrollbar = new tb(b.renderer, D(b.options.scrollbar, {
        margin: a.navigatorEnabled ? 0 : 10
      }), b), G(a.scrollbar, "changed", function (c) {
    ...
    addBaseSeriesEvents: function () {
      var a = this.baseSeries;
      if (a && a.xAxis && this.navigatorOptions.adaptToUpdatedData !== !1) G(a, "updatedData", this.updatedDataHandler), G(a.xAxis, "foundExtremes", this.modifyBaseAxisExtremes), a.userOptions.events = v(a.userOptions.event, {
  ...
  Kb.prototype = {
    clickButton: function (a, b) {
      ...
      if (!(j === null || k === null || a === c.selected)) {
        ...
        if (n === "month" || n === "year") {
          if (h) {
            if (n = {
              ...
              dataMin: j,
              dataMax: k
            }, l = h.minFromRange.call(n), z(n.newMax)) m = n.newMax;
          } else i = g;
        ...
        }), c.setSelected(a)) : (p = sa(e.options.xAxis)[0], t = p.range, p.range = i, s = p.min, p.min = r, c.setSelected(a), G(e, "load", function () {
          p.range = t;
          p.min = s;
        }));
      }
    ...
    drawInput: function (a) {
      function b() {
        var a = j.value,
            ...
            f = e.dataMin,
            h = e.dataMax;
        if (b !== j.previousValue) j.previousValue = b, z(b) || (b = a.split("-"), b = ea.UTC(H(b[0]), H(b[1]) - 1, H(b[2]))), z(b) && (Q.global.useUTC || (b += new ea().getTimezoneOffset() * 6E4), i ? b > c.maxInput.HCTime ? b = x : b < f && (b = f) : b < c.minInput.HCTime ? b = x : b > h && (b = h), b !== x && d.xAxis[0].setExtremes(i ? b : e.min, i ? e.max : b, x, x, {
    ...
    render: function (a, b) {
      ...
      }), c.updateButtonStates(), n !== !1)) c.div = k = ia("div", null, {
        position: "relative",
        height: 0,
        zIndex: 1
      ...
      }, i.inputPosition), !0, d.spacingBox), t(n) || (d = u.getBBox(), k[k.translateX < d.x + d.width + 10 ? "hide" : "show"]()), c.setInputValue("min", a), c.setInputValue("max", b));
      c.rendered = !0;
    },
    destroy: function () {
      var a = this.minInput,
  ...
  la.processData = function () {
    ...
    if (this.xAxis && this.processedYData) {
      ...
      for (a = 0; a < e - 1; a++) if (f = b > -1 ? d[a][b] : d[a], z(f) && c[a + 1] >= this.xAxis.min && f !== 0) {
        this.compareValue = f;
        break;
      }
    }
  ...
  S(P.prototype, "render", function (a) {
    if (this.chart.options._stock && this.xAxis) !this.clipBox && this.animate ? (this.clipBox = D(this.chart.clipBox), this.clipBox.width = this.xAxis.len, this.clipBox.height = this.yAxis.len) : this.chart[this.sharedClipKey] && (Qa(this.chart[this.sharedClipKey]), this.chart[this.sharedClipKey].attr({
